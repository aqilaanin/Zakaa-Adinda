...
<head>
    ...
    <link rel="stylesheet" href="kalku-penghasilan.css">
...
<body>
    ...
    <div class="main-content">
        <select name="var1" size="1">
            ...
            <option value="PERTA">Zakat Pertania
            <option value="RIKAZ">Zakat Rikaz
        </select>
        <br> <br>
        <div class="opsi">
            <div id="radio1">
                <input type="radio" name="var1" value="radio1"><p>Perbulan</p>
            </div>
            <div id="radio2">
                <input type="radio" name="var2" value="radio2"><p>Pertahun</p>
            </div>
        </div>
        <br>
        <div class="isisi">
            <table>
                ...
                <tr>
                    <td><b>Zakat wajib bayar</b></td>
                    <td> : </td>
                    <td> Rp <input type="number" name="var5"></td>
                </tr>
            </table>
        </div>
        <div class="tombol">
            <input type="button" name="var6" value="Hitung">
            <input type="reset" name="var7" value="Reset">
            <input type="submit" name="var8" value="Bayar" href="http://localhost/pjbl_pas/transfer/tfpenghasilan.php">
        </div>
    </div>
    <div class="footer">
